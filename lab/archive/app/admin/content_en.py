...
RECORDS = [
    ...
    (102, "Flash-Clone Substitution Protocol - Medical Annex",
     ...
     "growth clones with a foreshortened viability window, engineered to fail\n"
     "in a way that reads as an ordinary natural/medical death to any\n"
     "attending physician - deliberately so, so the local physician closing\n"
     "each case would have no reason to suspect anything and no need to be\n"
