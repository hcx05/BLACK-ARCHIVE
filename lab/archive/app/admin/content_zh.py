...
RECORDS = [
    ...
    (102, "Flash-Clone 替代協議 - 醫療附件",
     ...
     "同時不會引起家屬或殖民地行政單位的疑問。替代品是全身式 flash\n"
     "clone——一種加速培養的複製體，已知本來就無法長期存活，這是複製\n"
     "過程本身的限制，不是刻意打造的缺陷。放著不管，它們就會在短時間內\n"
     "以任何主治醫師都會判定為普通自然/醫療死亡的方式衰竭。這個既有的\n"
     "限制正是重點所在：負責結案的當地醫師才不會有任何理由起疑，也不\n"
     "需要被告知這個計畫的存在。\n\n"
     "本處的角色僅限於計畫端的醫療督導：在當地結案之後審核案件檔案，\n"
     "確認替代結果經得起一般查核，並維護複製體規格紀錄。本處沒有親自\n"
     "到場參與任何一次結案。\n\n"
     "交叉參照備註（後來補上，筆跡不同）：我事後審核並簽核了其中三份\n"
     "案件檔案，確認結案沒有問題。我做這件事的時候，還不知道自己確認的\n"
     "其實是什麼。我不覺得那樣就沒事，我也不\n"
     "打算假裝自己沒有選擇。\n"
     "- M.C."),
    ...
    (103, "書信片段 - C. Halsey 致 Section III，2517",
     ...
     "沒有經過他們同意，也沒有經過他們父母同意。我同時也在告訴你們，我\n"
     "相信這是必要的。這兩件事都是真的，我也不指望我們誰會因此覺得\n"
     "心安。\n\n"
     "依原送候選人名單繼續進行。"),
